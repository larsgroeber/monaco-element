...
(function () {
  ...
  (function (AMDLoader) {
    ...
    var LoaderEventRecorder =
    /** @class */
    function () {
      function LoaderEventRecorder(loaderAvailableTimestamp) {
        this._events = [new LoaderEvent(1
        /* LoaderAvailable */
    ...
    var NullLoaderEventRecorder =
    /** @class */
    function () {
      function NullLoaderEventRecorder() {}

      NullLoaderEventRecorder.prototype.record = function (type, detail) {// Nothing to do
      };
  ...
  (function (AMDLoader) {
    ...
    function () {
      ...
      ConfigurationOptionsUtil.mergeConfigurationOptions = function (overwrite, base) {
        ...
        var result = AMDLoader.Utilities.recursiveClone(base || {}); // Merge known properties and overwrite the unknown ones
    ...
    function () {
      ...
      Configuration.prototype._createSortedPathsRules = function () {
        var _this = this; // Create an array our of the paths rules, sorted descending by length to
  ...
  (function (AMDLoader) {
    ...
    function () {
      ...
      NodeScriptLoader.prototype._init = function (nodeRequire) {
        ...
        this._didInitialize = true; // capture node modules

        this._fs = nodeRequire('fs');
        this._vm = nodeRequire('vm');
        this._path = nodeRequire('path');
        this._crypto = nodeRequire('crypto'); // js-flags have an impact on cached data
      ...
      NodeScriptLoader.prototype._initNodeRequire = function (nodeRequire, moduleManager) {
        ...
        Module.prototype._compile = function (content, filename) {
          // remove shebang
          content = content.replace(/^#!.*/, ''); // create wrapper function
      ...
      NodeScriptLoader.prototype.load = function (moduleManager, scriptSrc, callback, errorback) {
        ...
        if (/^node\|/.test(scriptSrc)) {
          ...
          this._fs.readFile(scriptSrc, {
            ...
            var vmScriptSrc = normalizedScriptSrc; // Make the script src friendly towards electron
            ...
            if (!opts.nodeCachedDataDir) {
              _this._loadAndEvalScript(moduleManager, scriptSrc, vmScriptSrc, contents, {
      ...
      NodeScriptLoader.prototype._loadAndEvalScript = function (moduleManager, scriptSrc, vmScriptSrc, contents, options, recorder) {
        ...
        r.call(AMDLoader.global, moduleManager.getGlobalAMDRequireFunc(), moduleManager.getGlobalAMDDefineFunc(), vmScriptSrc, this._path.dirname(scriptSrc)); // signal done
  ...
  (function (AMDLoader) {
    ...
    function () {
      ...
      ModuleIdResolver._normalizeModuleId = function (moduleId) {
        ...
        r = r.replace(/^\.\//g, ''); // replace /aa/../ => / (BUT IGNORE /../../)
    ...
    var ModuleIdProvider =
    /** @class */
    function () {
      function ModuleIdProvider() {
        this._nextId = 0;
        this._strModuleIdToIntModuleId = new Map();
        this._intModuleIdToStrModuleId = []; // Ensure values 0, 1, 2 are assigned accordingly with ModuleId
    ...
    function () {
      ...
      ModuleManager.prototype._onLoad = function (moduleId) {
        if (this._currentAnnonymousDefineCall !== null) {
          ...
          this._currentAnnonymousDefineCall = null; // Hit an anonymous define call
      ...
      ModuleManager.prototype._onLoadError = function (moduleId, err) {
        var error = this._createLoadError(moduleId, err); // Find any 'local' error handlers, walk the entire chain of inverse dependencies if necessary.
      ...
      ModuleManager.prototype._hasDependencyPath = function (fromId, toId) {
        ...
        var queue = []; // Insert 'from' in queue
        ...
        var loadNextPath = function (err) {
          ...
          if (lastPathIndex >= paths.length) {
            ...
            _this._scriptLoader.load(_this, currentPath_1, function () {
              ...
              recorder_1.record(11
              /* EndLoadingScriptOK */
              , currentPath_1);

              _this._onLoad(moduleId);
            }, function (err) {
              recorder_1.record(12
      ...
      ModuleManager.prototype._loadPluginDependency = function (plugin, pluginDependency) {
        ...
        this._knownModules2[pluginDependency.id] = true; // Delegate the loading of the resource to the plugin
      ...
      ModuleManager.prototype._onModuleComplete = function (module) {
        ...
        module.complete(recorder, this._config, dependenciesValues); // Fetch and clear inverse dependencies
        ...
        if (inversePluginDeps) {
          ...
          this._inversePluginDependencies2.delete(module.id); // Resolve plugin dependencies one at a time
  ...
  (function (AMDLoader) {
      ...
      if (typeof AMDLoader.global.require !== 'undefined' || typeof require !== 'undefined') {
        ...
        if (typeof _nodeRequire_1 === 'function' && typeof _nodeRequire_1.resolve === 'function') {
          ...
          var nodeRequire = function (what) {
            moduleManager.getRecorder().record(33
            ...
            try {
              ...
              moduleManager.getRecorder().record(34
    ...
    if (typeof AMDLoader.global.define !== 'function' || !AMDLoader.global.define.amd) {
      moduleManager = new AMDLoader.ModuleManager(env, AMDLoader.createScriptLoader(env), DefineFunc, RequireFunc, AMDLoader.Utilities.getHighPerformanceTimestamp()); // The global variable require can configure the loader
  ...
  , 17
  /*vs/base/common/diff/diffChange*/
  ]), function (require, exports, diffChange_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
  ...
  /*exports*/
    ...
    exports.LANGUAGE_DEFAULT = 'en'; // OS detection
  ...
  /*exports*/
    ...
    exports.commonSuffixLength = commonSuffixLength; // --- unicode
    ...
    exports.isFullWidthCharacter = isFullWidthCharacter; // -- UTF-8 BOM
  ...
  /*vs/base/common/winjs.base*/
  ]), function (require, exports, winjs_base_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
    ...
    winjs_base_1.TPromise.addEventListener('error', promiseErrorHandler); // Avoid circular dependency on EventEmitter by implementing a subset of the interface.
  ...
  , 18
  /*vs/base/common/linkedList*/
  ]), function (require, exports, errors_1, functional_1, lifecycle_1, linkedList_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
    ...
    function anyEvent() {
      ...
      return function (listener, thisArgs, disposables) {
        ...
        return lifecycle_1.combinedDisposable(events.map(function (event) {
  ...
  , 8
  /*vs/base/common/lifecycle*/
  ]), function (require, exports, errors, winjs_base_1, cancellation_1, lifecycle_1) {
    'use strict';
    ...
    function always(winjsPromiseOrThenable, f) {
      if (isWinJSPromise(winjsPromiseOrThenable)) {
        ...
        // simple
        winjsPromiseOrThenable.then(function (_) {
          return f();
        }, function (_) {
          return f();
        });
  ...
  , 4
  /*vs/base/common/platform*/
  ]), function (require, exports, errors_1, lifecycle_1, winjs_base_1, async_1, platform_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
    ...
    function (_super) {
      ...
      function SimpleWorkerClient(workerFactory, moduleId) {
        ...
        _this._lazyProxy = new winjs_base_1.TPromise(function (c, e) {
          lazyProxyFulfill = c;
          lazyProxyReject = e;
        }, function () {}); // Send initialize message
      ...
      SimpleWorkerClient.prototype._request = function (method, args) {
        ...
        }, function () {// Cancel intentionally not supported
        });
      };
  ...
  , 2
  /*vs/editor/common/core/position*/
  ]), function (require, exports, range_1, position_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
  ...
  , 5
  /*vs/editor/common/core/uint*/
  ]), function (require, exports, characterClassifier_1, uint_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
  ...
  , 11
  /*vs/base/common/uri*/
  ]), function (require, exports, event_1, keyCodes_1, position_1, range_1, selection_1, winjs_base_1, cancellation_1, token_1, uri_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
  ...
  , 2
  /*vs/editor/common/core/position*/
  ]), function (require, exports, prefixSumComputer_1, position_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
  ...
  , 4
  /*vs/base/common/platform*/
  ]), function (require, exports, uri_1, winjs_base_1, range_1, diffComputer_1, diff_1, position_1, mirrorTextModel_1, linkComputer_1, inplaceReplaceSupport_1, wordHelper_1, standaloneBase_1, platform_1) {
    'use strict';
...
}).call(this); //# sourceMappingURL=workerMain.js.map