...
define("vs/editor/editor.main.nls.zh-tw", {
  ...
  "vs/base/browser/ui/aria/aria": ["{0} (再次出現)", "{0} (occurred {1} times)"],
  ...
  "vs/base/parts/quickopen/browser/quickOpenWidget": ["快速選擇器。輸入以縮小結果範圍。", "快速選擇器", "{0} Results"],
  ...
  "vs/editor/browser/widget/diffReview": ["關閉", "沒有任何行", "1 個行", "{0} 個行", "{1} 的 {0} 不同: 原始為 {2}，{3}，修改後為 {4}，{5}", "空白", "原始 {0},修改後{1}: {2", "+ 修改後 {0}: {1}", "- 原始 {0}: {1}", "移至下一個差異", "移至上一個差異"],
  ...
  "vs/editor/contrib/bracketMatching/bracketMatching": ["成對括弧的概觀尺規標記色彩。", "移至方括弧", "選取至括弧"],
  "vs/editor/contrib/caretOperations/caretOperations": ["將插入點左移", "將插入點右移"],
  "vs/editor/contrib/caretOperations/transpose": ["調換字母"],
  "vs/editor/contrib/clipboard/clipboard": ["剪下", "Cu&&t", "複製", "&&Copy", "貼上", "&&Paste", "隨語法醒目提示複製"],
  "vs/editor/contrib/codeAction/codeActionCommands": ["顯示修正 ({0})", "顯示修正", "快速修復...", "沒有可用的程式碼操作", "沒有可用的程式碼操作", "重構...", "沒有可用的重構", "來源動作...", "沒有可用的來源動作", "組織匯入", "沒有任何可用的組織匯入動作"],
  "vs/editor/contrib/comment/comment": ["切換行註解", "&&Toggle Line Comment", "加入行註解", "移除行註解", "切換區塊註解", "Toggle &&Block Comment"],
  "vs/editor/contrib/contextmenu/contextmenu": ["顯示編輯器內容功能表"],
  "vs/editor/contrib/cursorUndo/cursorUndo": ["Soft Undo"],
  "vs/editor/contrib/find/findController": ["尋找", "&&Find", "尋找選取項目", "尋找下一個", "尋找上一個", "尋找下一個選取項目", "尋找上一個選取項目", "取代", "&&Replace"],
  "vs/editor/contrib/find/findWidget": ["尋找", "尋找", "上一個符合項", "下一個相符項", "在選取範圍中尋找", "關閉", "取代", "取代", "取代", "全部取代", "切換取代模式", "僅反白顯示前 {0} 筆結果，但所有尋找作業會在完整文字上執行。", "{0} / {1}", "沒有結果"],
  "vs/editor/contrib/folding/folding": ["展開", "以遞迴方式展開", "摺疊", "以遞迴方式摺疊", "摺疊全部區塊註解", "折疊所有區域", "展開所有區域", "全部摺疊", "全部展開", "摺疊層級 {0}"],
  "vs/editor/contrib/fontZoom/fontZoom": ["編輯器字體放大", "編輯器字型縮小", "編輯器字體重設縮放"],
  "vs/editor/contrib/format/formatActions": ["在行 {0} 編輯了 1 項格式", "在行 {1} 編輯了 {0} 項格式", "在行 {0} 與行 {1} 之間編輯了 1 項格式", "在行 {1} 與行 {2} 之間編輯了 {0} 項格式", "尚無安裝適用於 \'{0}\' 檔案的格式器", "將文件格式化", "未安裝 \'{0}\' 檔案的文件格式器。", "將選取項目格式化", "未安裝 \'{0}\' 檔案的選擇格式器。"],
  "vs/editor/contrib/goToDefinition/goToDefinitionCommands": ["找不到 \'{0}\' 的定義", "找不到任何定義", " - {0} 個定義", "移至定義", "在一側開啟定義", "預覽定義", "找不到 \'{0}\' 的任何實作", "找不到任何實作", " – {0} 個實作", "前往實作", "預覽實作", "找不到 \'{0}\' 的任何類型定義", "找不到任何類型定義", " – {0} 個定義", "移至類型定義", "預覽類型定義"],
  "vs/editor/contrib/goToDefinition/goToDefinitionMouse": ["按一下以顯示 {0} 項定義。"],
  "vs/editor/contrib/gotoError/gotoError": ["移至下一個問題 (錯誤, 警告, 資訊)", "移至上一個問題 (錯誤, 警告, 資訊)", "移至檔案裡面的下一個問題 (錯誤, 警告, 資訊)", "移至檔案裡面的上一個問題 (錯誤, 警告, 資訊)"],
  "vs/editor/contrib/gotoError/gotoErrorWidget": ["({0}/{1})", "編輯器標記導覽小工具錯誤的色彩。", "編輯器標記導覽小工具警告的色彩。", "編輯器標記導覽小工具資訊的色彩", "編輯器標記導覽小工具的背景。"],
  ...
  "vs/editor/contrib/linesOperations/linesOperations": ["將行向上複製", "&&Copy Line Up", "將行向下複製", "Co&&py Line Down", "上移一行", "Mo&&ve Line Up", "下移一行", "Move &&Line Down", "遞增排序行", "遞減排序行", "修剪尾端空白", "刪除行", "縮排行", "凸排行", "在上方插入行", "在下方插入行", "左邊全部刪除", "刪除所有右方項目", "連接線", "轉置游標周圍的字元數", "轉換到大寫", "轉換到小寫"],
  "vs/editor/contrib/links/links": ["按住 Cmd 並按一下滑鼠按鈕可連入連結", "按住 Ctrl 並按一下滑鼠按鈕可連入連結", "按住 Cmd 並按一下滑鼠以執行命令", "按住 Ctrl 並按一下滑鼠以執行命令", "按住 Option 並按一下滑鼠按鈕以追蹤連結", "按住Alt並點擊以追蹤連結", "按住 Option 並按一下滑鼠以執行命令", "按住 Alt 並按一下滑鼠以執行命令", "因為此連結的格式不正確，所以無法開啟: {0}", "因為此連結目標遺失，所以無法開啟。", "開啟連結"],
  "vs/editor/contrib/message/messageController": ["無法在唯讀編輯器中編輯"],
  "vs/editor/contrib/multicursor/multicursor": ["在上方加入游標", "&&Add Cursor Above", "在下方加入游標", "A&&dd Cursor Below", "在行尾新增游標", "Add C&&ursors to Line Ends", "將選取項目加入下一個找到的相符項", "Add &&Next Occurrence", "將選取項目加入前一個找到的相符項中", "Add P&&revious Occurrence", "將最後一個選擇項目移至下一個找到的相符項", "將最後一個選擇項目移至前一個找到的相符項", "選取所有找到的相符項目", "Select All &&Occurrences", "變更所有發生次數"],
  ...
  "vs/editor/contrib/referenceSearch/referenceSearch": [" - {0} 個參考", "尋找所有參考"],
  "vs/editor/contrib/referenceSearch/referencesController": ["正在載入..."],
  "vs/editor/contrib/referenceSearch/referencesModel": ["個符號位於 {0} 中的第 {1} 行第 {2} 欄", "1 個符號位於 {0}, 完整路徑 {1}", "{0} 個符號位於 {1}, 完整路徑 {2}", "找不到結果", "在 {0} 中找到 1 個符號", "在 {1} 中找到 {0} 個符號", "在 {1} 個檔案中找到 {0} 個符號"],
  ...
  "vs/editor/contrib/rename/rename": ["沒有結果。", "已成功將 \'{0}\' 重新命名為 \'{1}\'。摘要: {2}", "重新命名無法執行。", "重新命名符號"],
  "vs/editor/contrib/rename/renameInputField": ["為輸入重新命名。請鍵入新名稱，然後按 Enter 以認可。"],
  "vs/editor/contrib/smartSelect/smartSelect": ["展開選取", "&&Expand Selection", "縮小選取", "&&Shrink Selection"],
  "vs/editor/contrib/snippet/snippetVariables": ["星期日", "星期一", "星期二", "星期三", "星期四", "星期五", "星期六", "週日", "週一", "週二", "週三", "週四", "週五", "週六", "1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月", "1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"],
  "vs/editor/contrib/suggest/suggestController": ["接受 \'{0}\' 時接受了插入下列文字: {1}", "觸發建議"],
  "vs/editor/contrib/suggest/suggestWidget": ["建議小工具的背景色彩。", "建議小工具的邊界色彩。", "建議小工具的前景色彩。", "建議小工具中所選項目的背景色彩。", "建議小工具中相符醒目提示的色彩。", "進一步了解...{0}", "{0}，建議，有詳細資料", "{0}，建議", "簡易說明...{0}", "正在載入...", "無建議。", "{0}，接受", "{0}，建議，有詳細資料", "{0}，建議"],
  "vs/editor/contrib/toggleTabFocusMode/toggleTabFocusMode": ["切換 TAB 鍵移動焦點"],
  "vs/editor/contrib/wordHighlighter/wordHighlighter": ["讀取存取符號時的背景顏色，如讀取變數。不能使用非透明的顏色來隱藏底層的樣式。", "寫入存取符號時的背景顏色，如寫入變數。不能使用非透明的顏色來隱藏底層的樣式。", "讀取存取期間 (例如讀取變數時) 符號的邊框顏色。", "寫入存取期間 (例如寫入變數時) 符號的邊框顏色。 ", "概述反白符號的尺規標記顏色。不能使用非透明的顏色來隱藏底層的樣式。", "概述反白寫入權限符號的尺規標記顏色。不能使用非透明的顏色來隱藏底層的樣式。", "移至下一個反白符號", "移至上一個反白符號"],
