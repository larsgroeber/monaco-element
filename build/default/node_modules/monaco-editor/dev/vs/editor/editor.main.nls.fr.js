...
define("vs/editor/editor.main.nls.fr", {
  ...
  "vs/base/browser/ui/aria/aria": ["{0} (s\'est reproduit)", "{0} (occurred {1} times)"],
  "vs/base/browser/ui/findinput/findInput": ["entrée"],
  "vs/base/browser/ui/findinput/findInputCheckboxes": ["Respecter la casse", "Mot entier", "Utiliser une expression régulière"],
  ...
  "vs/base/common/keybindingLabels": ["Ctrl", "Maj", "Alt", "Windows", "Ctrl", "Maj", "Alt", "Super", "Contrôle", "Maj", "Alt", "Commande", "Contrôle", "Maj", "Alt", "Windows", "Contrôle", "Maj", "Alt", "Super"],
  ...
  "vs/base/parts/quickopen/browser/quickOpenWidget": ["Sélecteur rapide. Tapez pour réduire les résultats.", "Sélecteur rapide", "{0} Results"],
  ...
  "vs/editor/browser/widget/diffEditorWidget": ["Impossible de comparer les fichiers car l\'un d\'eux est trop volumineux."],
  "vs/editor/browser/widget/diffReview": ["Fermer", "aucune ligne", "1 ligne", "{0} lignes", "Différence {0} sur {1} : original {2}, {3}, modifié {4}, {5}", "vide", "{0} d\'origine, {1} modifiées : {2}", "+ {0} modifiées : {1}", "- {0} d\'origine : {1}", "Accéder à la différence suivante", "Accéder la différence précédente"],
  ...
  "vs/editor/contrib/bracketMatching/bracketMatching": ["Couleur du marqueur de la règle d\'aperçu pour rechercher des parenthèses.", "Atteindre le crochet", "Select to Bracket"],
  "vs/editor/contrib/caretOperations/caretOperations": ["Déplacer le point d\'insertion vers la gauche", "Déplacer le point d\'insertion vers la droite"],
  "vs/editor/contrib/caretOperations/transpose": ["Transposer les lettres"],
  "vs/editor/contrib/clipboard/clipboard": ["Couper", "Cu&&t", "Copier", "&&Copy", "Coller", "&&Paste", "Copier avec la coloration syntaxique"],
  "vs/editor/contrib/codeAction/codeActionCommands": ["Afficher les correctifs ({0})", "Afficher les correctifs", "Correction rapide...", "Aucune action de code disponible", "Aucune action de code disponible", "Remanier...", "Aucune refactorisation disponible", "Action de la source", "Aucune action n\'est disponible", "Organiser les Imports", "Aucune action organiser les imports disponible"],
  "vs/editor/contrib/comment/comment": ["Activer/désactiver le commentaire de ligne", "&&Toggle Line Comment", "Ajouter le commentaire de ligne", "Supprimer le commentaire de ligne", "Activer/désactiver le commentaire de bloc", "Toggle &&Block Comment"],
  ...
  "vs/editor/contrib/find/findController": ["Rechercher", "&&Find", "Rechercher dans la sélection", "Rechercher suivant", "Rechercher précédent", "Sélection suivante", "Sélection précédente", "Remplacer", "&&Replace"],
  "vs/editor/contrib/find/findWidget": ["Rechercher", "Rechercher", "Correspondance précédente", "Correspondance suivante", "Rechercher dans la sélection", "Fermer", "Remplacer", "Remplacer", "Remplacer", "Tout remplacer", "Changer le mode de remplacement", "Seuls les {0} premiers résultats sont mis en évidence, mais toutes les opérations de recherche fonctionnent sur l’ensemble du texte.", "{0} sur {1}", "Aucun résultat"],
  ...
  "vs/editor/contrib/fontZoom/fontZoom": ["Agrandissement de l\'éditeur de polices de caractères", "Rétrécissement de l\'éditeur de polices de caractères", "Remise à niveau du zoom de l\'éditeur de polices de caractères"],
  ...
  "vs/editor/contrib/goToDefinition/goToDefinitionMouse": ["Cliquez pour afficher {0} définitions."],
  "vs/editor/contrib/gotoError/gotoError": ["Aller au problème suivant (Erreur, Avertissement, Info)", "Aller au problème précédent (Erreur, Avertissement, Info)", "Aller au problème suivant dans Fichiers (Erreur, Avertissement, Info)", "Aller au problème précédent dans Fichiers (Erreur, Avertissement, Info)"],
  "vs/editor/contrib/gotoError/gotoErrorWidget": ["({0}/{1})", "Couleur d\'erreur du widget de navigation dans les marqueurs de l\'éditeur.", "Couleur d\'avertissement du widget de navigation dans les marqueurs de l\'éditeur.", "Couleur d’information du widget de navigation du marqueur de l\'éditeur.", "Arrière-plan du widget de navigation dans les marqueurs de l\'éditeur."],
  "vs/editor/contrib/hover/hover": ["Afficher par pointage"],
  "vs/editor/contrib/hover/modesContentHover": ["Chargement..."],
  "vs/editor/contrib/inPlaceReplace/inPlaceReplace": ["Remplacer par la valeur précédente", "Remplacer par la valeur suivante"],
  ...
  "vs/editor/contrib/referenceSearch/referenceSearch": [" – {0} références", "Rechercher toutes les références"],
  "vs/editor/contrib/referenceSearch/referencesController": ["Chargement..."],
  "vs/editor/contrib/referenceSearch/referencesModel": ["symbole dans {0} sur la ligne {1}, colonne {2}", "1 symbole dans {0}, chemin complet {1}", "{0} symboles dans {1}, chemin complet {2}", "Résultats introuvables", "1 symbole dans {0}", "{0} symboles dans {1}", "{0} symboles dans {1} fichiers"],
  ...
  "vs/editor/contrib/rename/rename": ["Aucun résultat.", "\'{0}\' renommé en \'{1}\'. Récapitulatif : {2}", "Échec de l\'exécution du renommage.", "Renommer le symbole"],
  "vs/editor/contrib/rename/renameInputField": ["Renommez l\'entrée. Tapez le nouveau nom et appuyez sur Entrée pour valider."],
  "vs/editor/contrib/smartSelect/smartSelect": ["Développer la sélection", "&&Expand Selection", "Réduire la sélection", "&&Shrink Selection"],
  "vs/editor/contrib/snippet/snippetVariables": ["Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi", "Dim", "Lun", "Mar", "Mer", "Jeu", "Ven", "Sam", "Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novembre", "Décembre", "Jan", "Fév", "Mar", "Avr", "Mai", "Jun", "Jul", "Aoû", "Sep", "Oct", "Nov", "Déc"],
  ...
  "vs/editor/contrib/toggleTabFocusMode/toggleTabFocusMode": ["Activer/désactiver l\'utilisation de la touche Tab pour déplacer le focus"],
