 ...
 *-----------------------------------------------------------*/
(function () {
  var e = ["exports", "require", "vs/editor/common/core/position", "vs/base/common/winjs.base", "vs/base/common/platform", "vs/editor/common/core/uint", "vs/base/common/errors", "vs/editor/common/core/range", "vs/base/common/lifecycle", "vs/base/common/cancellation", "vs/base/common/event", "vs/base/common/uri", "vs/base/common/diff/diff", "vs/base/common/async", "vs/base/common/strings", "vs/base/common/keyCodes", "vs/editor/common/model/mirrorTextModel", "vs/base/common/diff/diffChange", "vs/base/common/linkedList", "vs/editor/common/core/selection", "vs/editor/common/core/token", "vs/base/common/functional", "vs/editor/common/core/characterClassifier", "vs/editor/common/diff/diffComputer", "vs/editor/common/model/wordHelper", "vs/editor/common/modes/linkComputer", "vs/editor/common/modes/supports/inplaceReplaceSupport", "vs/editor/common/standalone/standaloneBase", "vs/editor/common/viewModel/prefixSumComputer", "vs/base/common/worker/simpleWorker", "vs/editor/common/services/editorSimpleWorker"],
      t = function (t) {
              ...
              s._fs.readFile(g, function (e, t) {
                var o = {
                  ...
                  cachedData: t
                    ...
                    u = s._loadAndEvalScript(n, r, f, p, o, c);

                i(), s._processCachedData(n, u, g);
              });
  ...
  !function (e) {
      ...
      return e.prototype.ElementsAreEqual = function (e, t) {
        ...
        if (!s[0]) {
          var h = this.ComputeDiffRecursive(e, d, r, f, s),
              p = [];
          return p = s[0] ? [new n.DiffChange(d + 1, t - (d + 1) + 1, f + 1, o - (f + 1) + 1)] : this.ComputeDiffRecursive(d + 1, t, f + 1, o, s), this.ConcatenateChanges(h, p);
        }
        ...
        do {
          (b = P + e) === L || b < N && c[b - 1] < c[b + 1] ? (m = (f = c[b + 1]) - P - i, f < A && E.MarkNextChange(), A = f, E.AddModifiedElement(f + 1, m), P = b + 1 - e) : (m = (f = c[b - 1] + 1) - P - i, f < A && E.MarkNextChange(), A = f - 1, E.AddOriginalElement(f, m + 1), P = b - 1 - e), M >= 0 && (e = (c = this.m_forwardHistory[M])[0], L = 1, N = c.length - 1);
        } while (--M >= -1);
        ...
        if (C = E.getReverseChanges(), y[0]) {
          ...
          S = [new n.DiffChange(w, h - w + 1, D, g - D + 1)];
        } else {
          E = new s(), L = u, N = a, P = p[0] - _[0] - l, A = Number.MAX_VALUE, M = v ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;

          do {
            (b = P + o) === L || b < N && d[b - 1] >= d[b + 1] ? (m = (f = d[b + 1] - 1) - P - l, f > A && E.MarkNextChange(), A = f + 1, E.AddOriginalElement(f + 1, m + 1), P = b + 1 - o) : (m = (f = d[b - 1]) - P - l, f > A && E.MarkNextChange(), A = f, E.AddModifiedElement(f + 1, m + 1), P = b - 1 - o), M >= 0 && (o = (d = this.m_reverseHistory[M])[0], L = 1, N = d.length - 1);
          } while (--M >= -1);
        ...
        for (d = 1; d <= g / 2 + 1; d++) {
          ...
          for (f = this.ClipDiagonalBound(b - d, d, b, _), h = this.ClipDiagonalBound(b + d, d, b, _), N = f; N <= h; N += 2) {
            for (c = (l = N === f || N < h && v[N - 1] < v[N + 1] ? v[N + 1] : v[N - 1] + 1) - (N - b) - S, P = l; l < t && c < i && this.ElementsAreEqual(l + 1, c + 1);) l++, c++;

            if (v[N] = l, l + c > A + M && (A = l, M = c), !L && Math.abs(N - C) <= d - 1 && l >= y[N]) return s[0] = l, u[0] = c, P <= y[N] && d <= 1448 ? this.WALKTRACE(b, f, h, S, C, p, m, E, v, y, l, t, s, c, i, u, L, a) : null;
          }

          var w = (A - e + (M - r) - d) / 2;
          if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(A, this.OriginalSequence, w)) return a[0] = !0, s[0] = A, u[0] = M, w > 0 && d <= 1448 ? this.WALKTRACE(b, f, h, S, C, p, m, E, v, y, l, t, s, c, i, u, L, a) : (e++, r++, [new n.DiffChange(e, t - e + 1, r, i - r + 1)]);

          for (p = this.ClipDiagonalBound(C - d, d, C, _), m = this.ClipDiagonalBound(C + d, d, C, _), N = p; N <= m; N += 2) {
            for (c = (l = N === p || N < m && y[N - 1] >= y[N + 1] ? y[N + 1] - 1 : y[N - 1]) - (N - C) - E, P = l; l > e && c > r && this.ElementsAreEqual(l, c);) l--, c--;

            if (y[N] = l, L && Math.abs(N - b) <= d && l <= v[N]) return s[0] = l, u[0] = c, P >= v[N] && d <= 1448 ? this.WALKTRACE(b, f, h, S, C, p, m, E, v, y, l, t, s, c, i, u, L, a) : null;
          }

          if (d <= 1447) {
            var D = new Array(h - f + 2);
            D[0] = b - f + 1, o.Copy(v, f, D, 1, h - f + 1), this.m_forwardHistory.push(D), (D = new Array(m - p + 2))[0] = C - p + 1, o.Copy(y, p, D, 1, m - p + 1), this.m_reverseHistory.push(D);
          }
        }

        return this.WALKTRACE(b, f, h, S, C, p, m, E, v, y, l, t, s, c, i, u, L, a);
        ...
        for (l = e.length - 1; l >= 0; l--) {
          ...
          for (var o = n.originalLength > 0, s = n.modifiedLength > 0, d = 0, f = this._boundaryScore(n.originalStart, n.originalLength, n.modifiedStart, n.modifiedLength), h = 1;; h++) {
            var p = n.originalStart - h,
                m = n.modifiedStart - h;
            if (p < r || m < i) break;
            ...
            var g = this._boundaryScore(p, n.originalLength, m, n.modifiedLength);

            g > f && (f = g, d = h);
          }

          n.originalStart -= d, n.modifiedStart -= d;
        }
    ...
    var n = function () {
      ...
      return e.prototype.isEmpty = function () {
        ...
        return function () {
          for (var e = r._first; e instanceof n; e = e.next) if (e === i) {
            if (e.prev && e.next) {
              var t = e.prev;
    ...
    if (t.LANGUAGE_DEFAULT = "en", "object" == typeof process && "function" == typeof process.nextTick && "string" == typeof process.platform) {
      ...
      if (u) try {
        var a = JSON.parse(u),
            l = a.availableLanguages["*"];
        a.locale, l || t.LANGUAGE_DEFAULT, a._translationsConfigFile;
      } catch (e) {}
      o = !0;
    } else if ("object" == typeof navigator) {
      var c = navigator.userAgent;
      n = c.indexOf("Windows") >= 0, r = c.indexOf("Macintosh") >= 0, i = c.indexOf("Linux") >= 0, s = !0, navigator.language;
    }
    ...
    t.format = function (e) {
      ...
      return -1;
    }, t.compare = o, t.compareIgnoreCase = function (e, t) {
      for (var n = Math.min(e.length, t.length), r = 0; r < n; r++) {
        ...
        if (i !== a) {
          u(i) && (i += 32), u(a) && (a += 32);
          var l = i - a;
          if (0 !== l) return s(i) && s(a) ? l : o(e.toLowerCase(), t.toLowerCase());
        }
      }

      return e.length < t.length ? -1 : e.length > t.length ? 1 : 0;
    }, t.isLowerAsciiLetter = s, t.isUpperAsciiLetter = u, t.equalsIgnoreCase = function (e, t) {
    ...
    t.isBasicASCII = function (e) {
      ...
      for (var t = 0, n = e.length; t < n; t++) if (c(e.charCodeAt(t))) return !0;

      return !1;
    }, t.isFullWidthCharacter = c, t.UTF8_BOM_CHARACTER = String.fromCharCode(65279), t.startsWithUTF8BOM = function (e) {
  ...
  r(e[11], t([1, 0, 4]), function (e, t, n) {
    ...
    function s(e, t) {
      ...
      if (o && (i += o, i += ":"), (s || "file" === o) && (i += f, i += f), s) {
        var c = s.indexOf("@");

        if (-1 !== c) {
          var d = s.substr(0, c);
          s = s.substr(c + 1), -1 === (c = d.indexOf(":")) ? i += n(d, !1) : (i += n(d.substr(0, c), !1), i += ":", i += n(d.substr(c + 1), !1)), i += "@";
        }
      ...
      if (u) {
        if (u.length >= 3 && 47 === u.charCodeAt(0) && 58 === u.charCodeAt(2)) {
          (h = u.charCodeAt(1)) >= 65 && h <= 90 && (u = "/" + String.fromCharCode(h + 32) + ":" + u.substr(3));
        } else if (u.length >= 2 && 58 === u.charCodeAt(1)) {
          var h = u.charCodeAt(0);
          h >= 65 && h <= 90 && (u = String.fromCharCode(h + 32) + ":" + u.substr(2));
        }
    ...
    var u,
      ...
      return e.isUri = function (t) {
        ...
        var t = e.scheme,
            ...
            i = e.query,
            o = e.fragment;
        return void 0 === t ? t = this.scheme : null === t && (t = d), void 0 === n ? n = this.authority : null === n && (n = d), void 0 === r ? r = this.path : null === r && (r = d), void 0 === i ? i = this.query : null === i && (i = d), void 0 === o ? o = this.fragment : null === o && (o = d), t === this.scheme && n === this.authority && r === this.path && i === this.query && o === this.fragment ? this : new m(t, n, r, i, o);
      }, e.parse = function (e) {
        var t = h.exec(e);
        return t ? new m(t[2] || d, decodeURIComponent(t[4] || d), decodeURIComponent(t[5] || d), decodeURIComponent(t[7] || d), decodeURIComponent(t[9] || d)) : new m(d, d, d, d, d);
      }, e.file = function (e) {
        var t = d;

        if (n.isWindows && (e = e.replace(/\\/g, f)), e[0] === f && e[1] === f) {
          var r = e.indexOf(f, 2);
          -1 === r ? (t = e.substring(2), e = f) : (t = e.substring(2, r), e = e.substring(r) || f);
        }
    ...
    var m = function (e) {
      ...
      return o(t, e), Object.defineProperty(t.prototype, "fsPath", {
        ...
        g = (u = {}, u[58] = "%3A", u[47] = "%2F", u[63] = "%3F", u[35] = "%23", u[91] = "%5B", u[93] = "%5D", u[64] = "%40", u[33] = "%21", u[36] = "%24", u[38] = "%26", u[39] = "%27", u[40] = "%28", u[41] = "%29", u[42] = "%2A", u[43] = "%2B", u[44] = "%2C", u[59] = "%3B", u[61] = "%3D", u[32] = "%20", u);
  });
  var s;
  !function () {
    ...
    t("WinJS/Core/_Global", [], function () {
      ...
      function g(t, n) {
        ...
        if (i) {
          ...
          for (s = 0, u = Array.isArray(i) ? i.length : 1; s < u; s++) {
            ...
            if (o._traceAsyncOperationCompleted(a.asyncOpID, f), d) {
              var h = !1;

              try {
                c ? (o._traceAsyncCallbackStarting(a.asyncOpID), h = !0, c.handlesOnError || _(d, r, l, t, c), d._setCompleteValue(c(r))) : d._setChainedErrorValue(r, t);
              } catch (e) {
      ...
      function S(e, t) {
        var n;
        n = t && "object" == typeof t && "function" == typeof t.then ? I : R, e._value = t, e._setState(n);
      }
      ...
      w = {
        ...
        enter: function (e) {
          var t = e._value;
          if (t instanceof j && t._state !== F && t._state !== R) y(t, {
            promise: e
          });else {
            var n = function (r) {
      ...
      var q,
        ...
        supportedForProcessing: !1
          ...
          j = n.Class.derive(K, function (e) {
        A && (!0 === A || A & M.thenPromise) && (this._stack = H._getStack()), this._creator = e, this._setState(w), this._run();
      }, {
        _creator: null,
        ...
        A && (!0 === A || A & M.errorPromise) && (this._stack = H._getStack()), this._value = e, _(this, e, d);
      }, {
        cancel: function () {},
        done: function (e, t) {
          var n = this._value;
        ...
        A && (!0 === A || A & M.exceptionPromise) && (this._stack = H._getStack()), this._value = e, _(this, e, f);
      }, {}, {
        supportedForProcessing: !1
      }),
        ...
        supportedForProcessing: !1
          ...
          H = n.Class.derive(K, function (e, t) {
        A && (!0 === A || A & M.promise) && (this._stack = H._getStack()), this._oncancel = t, this._setState(w), this._run();
  ...
  }), r(e[10], t([1, 0, 6, 21, 8, 18]), function (e, t, n, r, i, o) {
    "use strict";
    ...
    t.EventMultiplexer = l, t.once = function (e) {
      ...
      var i,
        ...
        onFirstListenerAdd: function () {
          i = e(function (e) {
            u++, o = t(o, e), r && !s && l.fire(o), clearTimeout(s), s = setTimeout(function () {
              var e = o;
              o = void 0, s = void 0, (!r || u > 1) && l.fire(e), u = 0;
            }, n);
          });
        },
        onLastListenerRemove: function () {
    ...
    t.EventBufferer = c, t.mapEvent = s, t.filterEvent = u;
    ...
    var f = function () {
      function e() {
        this.emitter = new a(), this.event = this.emitter.event, this.disposable = i.Disposable.None;
      }
  ...
  }), r(e[13], t([1, 0, 6, 3, 9, 8]), function (e, t, n, r, i, s) {
    "use strict";
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      return u(e) ? e : r.TPromise.as(e);
    }, t.createCancelablePromise = a, t.asWinJsPromise = function (e) {
      var t = new i.CancellationTokenSource();
    ...
    t.ShallowCancelThenPromise = f, t.timeout = function (e) {
      return a(function (t) {
        return new Promise(function (r, i) {
          var o = setTimeout(r, e);
          t.onCancellationRequested(function (e) {
            clearTimeout(o), i(n.canceled());
          });
        });
      });
    }, t.always = l, t.first2 = function (e, t, n) {
      ...
      var r = 0,
          i = e.length,
          o = function () {
        return r >= i ? Promise.resolve(n) : (0, e[r++])().then(function (e) {
      ...
      var i = 0,
          o = e.length,
          s = function () {
        return i >= o ? r.TPromise.as(n) : (0, e[i++])().then(function (e) {
          return t(e) ? r.TPromise.as(e) : s();
        });
      };
    ...
    t.RunOnceScheduler = m;
  }), r(e[29], t([1, 0, 6, 8, 3, 13, 4]), function (e, t, n, r, i, s, u) {
    "use strict";
    ...
    var c = function () {
      ...
      function t(t, n) {
        ...
        var u = null;
        void 0 !== self.require && "function" == typeof self.require.getConfig ? u = self.require.getConfig() : void 0 !== self.requirejs && (u = self.requirejs.s.contexts._.config), r._lazyProxy = new i.TPromise(function (e, t) {
          o = e, s = t;
        }, function () {}), r._onModuleLoaded = r._protocol.sendMessage(a, [r._worker.getId(), n, u]), r._onModuleLoaded.then(function (e) {
          for (var t = {}, n = 0; n < e.length; n++) t[e[n]] = d(e[n], l);
    ...
    t.SimpleWorkerServer = f, t.create = function (e) {
      return new f(e, null);
    };
    ...
    t.Range = r;
  }), r(e[19], t([1, 0, 7, 2]), function (e, t, n, r) {
    "use strict";
    ...
    t.CharacterSet = i;
  }), r(e[23], t([1, 0, 12, 14]), function (e, t, n, r) {
    "use strict";
    ...
    var o = 5e3,
      ...
      return e.prototype.getLength = function () {
        ...
        for (var r = [], i = [], o = [], s = 0, u = t; u <= n; u++) for (var l = this._lines[u], c = e ? this._startColumns[u] : 1, d = e ? this._endColumns[u] : l.length + 1, f = c; f < d; f++) r[s] = l.charCodeAt(f - 1), i[s] = u + 1, o[s] = f, s++;
      ...
      return e.createFromDiffResult = function (t, n, r, o, u, a, c) {
        ...
        if (0 === n.originalLength ? (d = r.getStartLineNumber(n.originalStart) - 1, f = 0) : (d = r.getStartLineNumber(n.originalStart), f = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), 0 === n.modifiedLength ? (h = o.getStartLineNumber(n.modifiedStart) - 1, p = 0) : (h = o.getStartLineNumber(n.modifiedStart), p = o.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && 0 !== n.originalLength && 0 !== n.modifiedLength && u()) {
      ...
      return e.prototype.computeDiff = function () {
        ...
        for (var o = [], s = 0, a = 0, n = -1, l = e.length; n < l; n++) {
          for (var d = n + 1 < l ? e[n + 1] : null, f = d ? d.originalStart : this.originalLines.length, h = d ? d.modifiedStart : this.modifiedLines.length; s < f && a < h;) {
            ...
            if (p !== m) {
              for (var g = u._getFirstNonBlankColumn(p, 1), _ = u._getFirstNonBlankColumn(m, 1); g > 1 && _ > 1;) {
                if ((S = p.charCodeAt(g - 2)) !== (E = m.charCodeAt(_ - 2))) break;
                g--, _--;
              }
          ...
          d && (o.push(c.createFromDiffResult(this.shouldIgnoreTrimWhitespace, d, this.original, this.modified, this._continueProcessingPredicate.bind(this), this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), s += d.originalLength, a += d.modifiedLength);
        }
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      var o = i[0].indexOf(" ") >= 0 ? function (e, t, n, r) {
        ...
        for (var u; u = t.exec(n);) if (u.index <= i && t.lastIndex >= i) return {
          word: u[0],
  ...
  }), r(e[25], t([1, 0, 22, 5]), function (e, t, n, r) {
    "use strict";
    ...
    var i = function () {
      ...
      return e._createLink = function (e, t, n, r, i) {
        ...
        for (var r = (null === o && (o = new i([[1, 104, 2], [1, 72, 2], [1, 102, 6], [1, 70, 6], [2, 116, 3], [2, 84, 3], [3, 116, 4], [3, 84, 4], [4, 112, 5], [4, 80, 5], [5, 115, 9], [5, 83, 9], [5, 58, 10], [6, 105, 7], [6, 73, 7], [7, 108, 8], [7, 76, 8], [8, 101, 9], [8, 69, 9], [9, 58, 10], [10, 47, 11], [11, 47, 12]])), o), u = function () {
          ...
          for (var d = t.getLineContent(l), f = d.length, h = 0, p = 0, m = 0, g = 1, _ = !1, v = !1, y = !1; h < f;) {
            var b = !1,
                C = d.charCodeAt(h);
            ...
            if (13 === g) {
              ...
              1 === S && (a.push(e._createLink(u, d, l, p, h)), b = !0);
            } else if (12 === g) {
              var S;
              1 === (S = u.get(C)) ? b = !0 : g = 13;
  ...
  }), r(e[27], t([1, 0, 10, 15, 2, 7, 19, 3, 9, 20, 11]), function (e, t, n, r, i, o, s, u, a, l, c) {
    "use strict";
    ...
    }(d = t.MarkerTag || (t.MarkerTag = {}));
    var f;
    !function (e) {
      e[e.Hint = 1] = "Hint", e[e.Info = 2] = "Info", e[e.Warning = 4] = "Warning", e[e.Error = 8] = "Error";
    }(f = t.MarkerSeverity || (t.MarkerSeverity = {}));
    ...
    var i = function () {
      ...
      return e.prototype.getCount = function () {
        ...
        for (var t, n, i, o = 0, s = this.values.length - 1; o <= s;) if (t = o + (s - o) / 2 | 0, n = this.prefixSum[t], i = n - this.values[t], e < i) s = t - 1;else {
          if (!(e >= n)) break;
          o = t + 1;
        }
  ...
  }), r(e[16], t([1, 0, 28, 2]), function (e, t, n, r) {
    "use strict";
    ...
    t.MirrorTextModel = i;
  }), r(e[30], t([1, 0, 11, 3, 7, 23, 12, 2, 16, 25, 26, 24, 27, 4]), function (e, t, n, r, i, s, u, a, l, c, d, f, h, p) {
    "use strict";
    ...
    var m = function (e) {
      ...
      return t.prototype.computeDiff = function (e, t, n) {
        ...
        for (var s, a = [], l = 0, c = n; l < c.length; l++) {
          ...
          if ("number" == typeof p && (s = p), f) {
            var m = o.getValueInRange(f);
            if (h = h.replace(/\r\n|\n|\r/g, o.eol), m !== h) if (Math.max(h.length, m.length) > t._diffLimit) a.push({
              range: f,
              text: h
            });else for (var g = u.stringDiff(m, h, !1), _ = o.offsetAt(i.Range.lift(f).getStartPosition()), v = 0, y = g; v < y.length; v++) {
              var b = y[v],
                  C = o.positionAt(_ + b.originalStart),
                  S = o.positionAt(_ + b.originalStart + b.originalLength),
                  E = {
              ...
              o.getValueInRange(E.range) !== E.text && a.push(E);
            }
          }
        }
        ...
        if (s) {
          ...
          for (var d = s.createWordIterator(a), f = d.next(); !f.done && u.length <= t._suggestionsLimit; f = d.next()) {
            var h = f.value;
            c[h] || (c[h] = !0, isNaN(Number(h)) && u.push({
              type: "text",
              label: h,
              insertText: h,
              noAutoAccept: !0,
        ...
        var f = d.BasicInplaceReplace.INSTANCE.navigateValueSet(t, a, l, c, n);
        return r.TPromise.as(f);
    ...
    t.EditorSimpleWorkerImpl = _, t.create = function () {
      return new _(null);
    }, "function" == typeof importScripts && (p.globals.monaco = h.createMonacoBaseAPI());
  }), function () {
    "use strict";
...
}).call(this); //# sourceMappingURL=../../../../min-maps/vs/base/worker/workerMain.js.map