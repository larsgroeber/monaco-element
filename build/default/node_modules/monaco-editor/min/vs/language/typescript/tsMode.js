...
define("vs/language/typescript/languageFeatures", ["require", "exports"], function (e, t) {
  ...
  var a = function (e) {
    ...
    return __extends(a, e), Object.defineProperty(a.prototype, "triggerCharacters", {
      get: function () {
        return ["."];
      },
      enumerable: !0,
      ...
      return b(n, this._worker(r).then(function (e) {
        ...
        if (e) return e.entries.map(function (e) {
          return {
            uri: r,
            position: t,
            label: e.name,
      ...
      var n = this,
          ...
          o = r.uri,
          i = r.position;
      return b(t, this._worker(o).then(function (e) {
        return e.getCompletionEntryDetails(o.toString(), n._positionToOffset(o, i), r.label);
      }).then(function (e) {
        return e ? {
          uri: o,
          position: i,
  ...
  var l = function (t) {
    ...
    return __extends(e, t), e.prototype.provideSignatureHelp = function (e, t, n) {
      var r = this,
          o = e.uri;
      return b(n, this._worker(o).then(function (e) {
  ...
  var p = function (e) {
    ...
    return __extends(t, e), t.prototype.provideHover = function (e, t, n) {
      var o = this,
          i = e.uri;
      return b(n, this._worker(i).then(function (e) {
  ...
  var d = function (e) {
    ...
    return __extends(t, e), t.prototype.provideDocumentSymbols = function (e, t) {
      var u = this,
          c = e.uri;
      return b(t, this._worker(c).then(function (e) {
  ...
  var S = function (e) {
    ...
    return __extends(t, e), Object.defineProperty(t.prototype, "autoFormatTriggerCharacters", {
      ...
      var i = this,
          a = e.uri;
      return b(o, this._worker(a).then(function (e) {
