  ...
  Item.prototype.collapse = function (recursive) {
    ...
    if (recursive) {
      ...
      this.forEachChild(function (child) {
        collapseChildrenPromise = collapseChildrenPromise.then(function () {
    ...
    var doRefresh = function () {
      ...
      var result = childrenPromise.then(function (elements) {
        ...
        if (recursive) {
          ...
          _this.mapEachChild(function (child) {
            return child.updateVisibility();
          });

          return WinJS.TPromise.as(null);
        }
      });
      return result.then(null, onUnexpectedError).then(function () {
