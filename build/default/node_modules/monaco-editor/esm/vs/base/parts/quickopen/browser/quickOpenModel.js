...
function () {
  ...
  QuickOpenEntry.prototype.getAriaLabel = function () {
    return [this.getLabel(), this.getDescription(), this.getDetail()].filter(function (s) {
      return !!s;
    }).join(', ');
  };
  /**
...
function () {
  ...
  Renderer.prototype.renderTemplate = function (templateId, container, styles) {
    ...
    var detail = new HighlightedLabel(detailContainer); // Entry Group
  ...
  Renderer.prototype.renderElement = function (entry, templateId, data, styles) {
    ...
    if (entry instanceof QuickOpenEntry) {
      ...
      data.label.setValue(entry.getLabel(), entry.getDescription(), options); // Meta
