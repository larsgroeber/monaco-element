...
import { TPromise } from './winjs.base.js'; // ------ BEGIN Hook up error listeners to winjs promises
...
TPromise.addEventListener('error', promiseErrorHandler); // Avoid circular dependency on EventEmitter by implementing a subset of the interface.
