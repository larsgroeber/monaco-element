...
export function guessMimeTypes(path, firstLine) {
  ...
  var filename = paths.basename(path); // 1.) User configured mappings have highest priority
...
function guessMimeTypeByPath(path, filename, associations) {
  var filenameMatch;
  var patternMatch;
  var extensionMatch; // We want to prioritize associations based on the order they are registered so that the last registered
