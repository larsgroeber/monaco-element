...
function () {
  function Gesture() {
    ...
    this.handle = null;
    this.targets = [];
    this.toDispose.push(DomUtils.addDisposableListener(document, 'touchstart', function (e) {
      return _this.onTouchStart(e);
    }));
    this.toDispose.push(DomUtils.addDisposableListener(document, 'touchend', function (e) {
      return _this.onTouchEnd(e);
    }));
    this.toDispose.push(DomUtils.addDisposableListener(document, 'touchmove', function (e) {
