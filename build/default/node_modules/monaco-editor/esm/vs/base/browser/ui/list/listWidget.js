...
function () {
  ...
  TraitRenderer.prototype.disposeElement = function () {// noop
  };
...
function () {
  ...
  Trait.prototype.splice = function (start, deleteCount, elements) {
    ...
    var indexes = this.indexes.filter(function (i) {
      return i < start;
    }).concat(elements.map(function (hasTrait, i) {
      return hasTrait ? i + start : -1;
    }).filter(function (i) {
      return i !== -1;
    }), this.indexes.filter(function (i) {
      return i >= end;
    }).map(function (i) {
      return i + diff;
    }));
  ...
  Trait.prototype.contains = function (index) {
    return this.indexes.some(function (i) {
      return i === index;
    });
  };
...
function () {
  ...
  TraitSpliceable.prototype.splice = function (start, deleteCount, elements) {
    ...
    if (!this.getId) {
      return this.trait.splice(start, deleteCount, elements.map(function (e) {
        return false;
      }));
    }

    var pastElementsWithTrait = this.trait.get().map(function (i) {
      return _this.getId(_this.view.element(i));
    });
    var elementsWithTrait = elements.map(function (e) {
      return pastElementsWithTrait.indexOf(_this.getId(e)) > -1;
    });
...
function () {
  function KeyboardController(list, view, options) {
    ...
    var onKeyDown = chain(domEvent(view.domNode, 'keydown')).filter(function (e) {
...
function () {
  ...
  Object.defineProperty(MouseController.prototype, "onContextMenu", {
    get: function () {
      ...
      var fromKeydown = chain(domEvent(this.view.domNode, 'keydown')).map(function (e) {
        return new StandardKeyboardEvent(e);
      }).filter(function (e) {
      ...
      var fromMouse = chain(this.view.onContextMenu).filter(function () {
  ...
  __decorate([memoize], MouseController.prototype, "onContextMenu", null);
...
function () {
  function List(container, virtualDelegate, renderers, options) {
    ...
    this.focus = new FocusTrait(function (i) {
      return _this.getElementDomId(i);
    });
    this.selection = new Trait('selected');
    mixin(options, defaultStyles, false);
    renderers = renderers.map(function (r) {
      return new PipelineRenderer(r.templateId, [_this.focus.renderer, _this.selection.renderer, r]);
    });
    ...
    this.spliceable = new CombinedSpliceable([new TraitSpliceable(this.focus, this.view, options.identityProvider), new TraitSpliceable(this.selection, this.view, options.identityProvider), this.view]);
    this.disposables = [this.focus, this.selection, this.view, this._onDidDispose];
    this.onDidFocus = mapEvent(domEvent(this.view.domNode, 'focus', true), function () {
      return null;
    });
    this.onDidBlur = mapEvent(domEvent(this.view.domNode, 'blur', true), function () {
      return null;
    });
  ...
  Object.defineProperty(List.prototype, "onFocusChange", {
    get: function () {
      ...
      return mapEvent(this.eventBufferer.wrapEvent(this.focus.onChange), function (e) {
  ...
  Object.defineProperty(List.prototype, "onSelectionChange", {
    get: function () {
      ...
      return mapEvent(this.eventBufferer.wrapEvent(this.selection.onChange), function (e) {
        return _this.toListEvent(e);
      });
    },
    enumerable: true,
  ...
  List.prototype.focusPreviousPage = function () {
    ...
    if (currentlyFocusedElement !== firstPageElement) {
      ...
      if (this.view.getScrollTop() !== previousScrollTop) {
        // Let the scroll event listener run
        setTimeout(function () {
          return _this.focusPreviousPage();
        }, 0);
      }
    }
  };
