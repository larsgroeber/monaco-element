...
function () {
  function ListView(container, virtualDelegate, renderers, options) {
    ...
    var onDragOver = mapEvent(domEvent(this.rowsContainer, 'dragover'), function (e) {
      return new DragMouseEvent(e);
    });
  ...
  ListView.prototype._splice = function (start, deleteCount, elements) {
    ...
    var insertRanges = [elementsRange].concat(unrenderedRestRanges).map(function (r) {
      return intersect(renderRange, r);
    });
  ...
  ListView.prototype.render = function (renderTop, renderHeight) {
    ...
    if (canUseTranslate3d() && !isWindows
    /* Windows: translate3d breaks subpixel-antialias (ClearType) unless a background is defined */
    ) {
  ...
  Object.defineProperty(ListView.prototype, "onMouseClick", {
    ...
    get: function () {
      ...
      return filterEvent(mapEvent(domEvent(this.domNode, 'click'), function (e) {
  ...
  Object.defineProperty(ListView.prototype, "onMouseDblClick", {
    get: function () {
      ...
      return filterEvent(mapEvent(domEvent(this.domNode, 'dblclick'), function (e) {
        return _this.toMouseEvent(e);
      }), function (e) {
        return e.index >= 0;
      });
  ...
  Object.defineProperty(ListView.prototype, "onMouseDown", {
    get: function () {
      ...
      return filterEvent(mapEvent(domEvent(this.domNode, 'mousedown'), function (e) {
        return _this.toMouseEvent(e);
      }), function (e) {
        return e.index >= 0;
      });
  ...
  Object.defineProperty(ListView.prototype, "onContextMenu", {
    get: function () {
      ...
      return filterEvent(mapEvent(domEvent(this.domNode, 'contextmenu'), function (e) {
        return _this.toMouseEvent(e);
      }), function (e) {
        return e.index >= 0;
      });
  ...
  Object.defineProperty(ListView.prototype, "onTouchStart", {
    get: function () {
      ...
      return filterEvent(mapEvent(domEvent(this.domNode, 'touchstart'), function (e) {
  ...
  Object.defineProperty(ListView.prototype, "onTap", {
    get: function () {
      ...
      return filterEvent(mapEvent(domEvent(this.rowsContainer, TouchEventType.Tap), function (e) {
