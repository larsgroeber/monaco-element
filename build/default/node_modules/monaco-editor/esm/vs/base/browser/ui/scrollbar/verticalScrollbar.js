...
function (_super) {
  ...
  function VerticalScrollbar(scrollable, options, host) {
    var _this = _super.call(this, {
      ...
      host: host,
      scrollbarState: new ScrollbarState(options.verticalHasArrows ? options.arrowSize : 0, options.vertical === ScrollbarVisibility.Hidden ? 0 : options.verticalScrollbarSize, // give priority to vertical scroll bar over horizontal and let it scroll all the way to the bottom
      0),
    ...
    if (options.verticalHasArrows) {
      ...
      _this._createArrow({
        ...
        onActivate: function () {
          return _this._host.onMouseWheel(new StandardMouseWheelEvent(null, 0, 1));
        }
      });
