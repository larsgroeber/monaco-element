  ...
  function IconLabel(container, options) {
    ...
    if (options && options.supportDescriptionHighlights) {
      _this.descriptionNodeFactory = function () {
        return _this._register(new HighlightedLabel(dom.append(_this.labelDescriptionContainer.element, dom.$('span.label-description'))));
      };
    } else {
      _this.descriptionNodeFactory = function () {
...
function (_super) {
  ...
  FileLabel.prototype.setFile = function (file, provider, userHome) {
    ...
    this.setValue(getBaseLabel(file), parent && parent !== '.' ? getPathLabel(parent, userHome, provider) : '', {
      title: file.fsPath
    });
  };
