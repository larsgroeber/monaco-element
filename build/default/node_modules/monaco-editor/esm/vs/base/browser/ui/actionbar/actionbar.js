...
function () {
  ...
  BaseActionItem.prototype.render = function (container) {
    ...
    this.builder.on(EventType.Tap, function (e) {
  ...
  BaseActionItem.prototype._updateEnabled = function () {// implement in subclass
  };
...
function () {
  function ActionBar(container, options) {
    ...
    this.toDispose.push(this._actionRunner.onDidRun(function (e) {
      return _this._onDidRun.fire(e);
    }));
    this.toDispose.push(this._actionRunner.onDidBeforeRun(function (e) {
    ...
    this.toDispose.push(this.focusTracker.onDidFocus(function () {
  ...
  ActionBar.prototype.push = function (arg, options) {
    ...
    actions.forEach(function (action) {
      ...
      actionItemElement.setAttribute('role', 'presentation'); // Prevent native context menu on actions
