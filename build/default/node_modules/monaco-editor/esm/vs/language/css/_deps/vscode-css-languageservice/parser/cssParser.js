...
import * as languageFacts from '../services/languageFacts.js'; /// <summary>
...
function () {
  ...
  Parser.prototype._parseRuleset = function (isNested) {
    ...
    while (this.accept(TokenType.Comma) && node.getSelectors().addChild(this._parseSelector(isNested))) {// loop
    }
...
export { Parser }; //# sourceMappingURL=cssParser.js.map