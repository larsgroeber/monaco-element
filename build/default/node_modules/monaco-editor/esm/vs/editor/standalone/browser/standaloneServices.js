...
(function (StaticServices) {
  ...
  function init(overrides) {
    ...
    var result = new ServiceCollection(); // Initialize the service collection with the overrides
  ...
  StaticServices.uriDisplayService = define(IUriDisplayService, function () {
    return new SimpleUriDisplayService();
  });
  ...
  StaticServices.modelService = define(IModelService, function (o) {
    return new ModelServiceImpl(StaticServices.markerService.get(o), StaticServices.configurationService.get(o));
  });
  StaticServices.editorWorkerService = define(IEditorWorkerService, function (o) {
    return new EditorWorkerServiceImpl(StaticServices.modelService.get(o), StaticServices.resourceConfigurationService.get(o));
  });
  ...
  StaticServices.progressService = define(IProgressService, function () {
    return new SimpleProgressService();
  });
...
function (_super) {
  ...
  function DynamicStandaloneServices(domElement, overrides) {
    ...
    ensure(IKeybindingService, function () {
    ...
    var contextViewService = ensure(IContextViewService, function () {
      return _this._register(new ContextViewService(domElement, telemetryService, new NullLogService()));
    });
    ensure(IContextMenuService, function () {
      return _this._register(new ContextMenuService(domElement, telemetryService, notificationService, contextViewService));
    });
    ensure(IMenuService, function () {
      return new SimpleMenuService(commandService);
    });
