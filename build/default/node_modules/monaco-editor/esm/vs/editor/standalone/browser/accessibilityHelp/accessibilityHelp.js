...
function (_super) {
  ...
  AccessibilityHelpWidget.prototype._buildContent = function () {
    ...
    switch (opts.accessibilitySupport) {
      ...
      /* Unknown */
      :
        var turnOnMessage = platform.isMacintosh ? nls.localize("changeConfigToOnMac", "To configure the editor to be optimized for usage with a Screen Reader press Command+E now.") : nls.localize("changeConfigToOnWinLinux", "To configure the editor to be optimized for usage with a Screen Reader press Control+E now.");
        text += '\n\n - ' + turnOnMessage;
        break;
    ...
    var openDocMessage = platform.isMacintosh ? nls.localize("openDocMac", "Press Command+H now to open a browser window with more information related to editor accessibility.") : nls.localize("openDocWinLinux", "Press Control+H now to open a browser window with more information related to editor accessibility.");
    text += '\n\n - ' + openDocMessage;
