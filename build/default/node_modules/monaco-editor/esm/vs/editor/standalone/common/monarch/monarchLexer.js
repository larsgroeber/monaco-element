...
function () {
  function MonarchTokenizer(modeService, standaloneThemeService, modeId, lexer) {
    ...
    this._modeId = modeId;
    this._lexer = lexer;
    this._embeddedModes = Object.create(null); // Set up listening for embedded modes
  ...
  MonarchTokenizer.prototype._myTokenize = function (line, lineState, offsetDelta, tokensCollector) {
    ...
    var pos = 0; // regular expression group matching
    ...
    while (pos < lineLength) {
      ...
      if (groupActions) {
        ...
        rule = groupRule; // cleanup if necessary
        ...
        if (action.switchTo && typeof action.switchTo === 'string') {
          ...
          if (action.next === '@push') {
            if (stack.depth >= this._lexer.maxStack) {
              monarchCommon.throwError(this._lexer, 'maximum tokenizer stack size reached: [' + stack.state + ',' + stack.parent.state + ',...]');
            } else {
  ...
  MonarchTokenizer.prototype._locateMode = function (mimetypeOrModeId) {
    ...
    var modeId = this._modeService.getModeId(mimetypeOrModeId); // Fire mode loading event
