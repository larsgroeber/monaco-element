...
function () {
      ...
      _this._editor.changeViewZones(function (accessor) {
        ...
        while (groupsIndex < groups.length && codeLensIndex < _this._lenses.length) {
          ...
          if (codeLensLineNumber < symbolsLineNumber) {
            ...
            _this._lenses.splice(codeLensIndex, 0, new CodeLens(groups[groupsIndex], _this._editor, helper, accessor, _this._commandService, _this._notificationService, function () {
        ...
        while (groupsIndex < groups.length) {
          _this._lenses.push(new CodeLens(groups[groupsIndex], _this._editor, helper, accessor, _this._commandService, _this._notificationService, function () {
            return _this._detectVisibleLenses.schedule();
          }));
  ...
  CodeLensContribution = __decorate([__param(1, ICommandService), __param(2, INotificationService)], CodeLensContribution);
