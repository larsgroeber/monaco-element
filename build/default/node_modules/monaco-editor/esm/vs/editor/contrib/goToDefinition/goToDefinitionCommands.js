  ...
  DefinitionAction.prototype.run = function (accessor, editor) {
    ...
    var definitionPromise = this._getDeclarationsAtPosition(model, pos).then(function (references) {
      ...
      for (var i = 0; i < references.length; i++) {
        ...
        if (_this._configuration.filterCurrent && uri.toString() === model.uri.toString() && Range.containsPosition(range, pos) && idxOfCurrent === -1) {
...
var goToDeclarationKb = platform.isWeb ? 2048
/* CtrlCmd */
| 70
/* F12 */
: 70
