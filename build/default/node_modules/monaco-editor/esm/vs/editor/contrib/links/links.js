...
function () {
        ...
        switch (_a.label) {
          case 0:
            ...
            this.computePromise = async.createCancelablePromise(function (token) {
              return getLinks(_this.editor.getModel(), token);
            });
            _a.label = 1;
  ...
  LinkDetector.prototype.isEnabled = function (mouseEvent, withKey) {
    return mouseEvent.target.type === MouseTargetType.CONTENT_TEXT && (mouseEvent.hasTriggerModifier || withKey && withKey.keyCodeIsTriggerKey);
  };
