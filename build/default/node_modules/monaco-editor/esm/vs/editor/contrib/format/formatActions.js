...
function () {
  function FormatOnType(editor, workerService) {
    ...
    this.callOnDispose = [];
    this.callOnModel = [];
    this.callOnDispose.push(editor.onDidChangeConfiguration(function () {
      return _this.update();
    }));
    this.callOnDispose.push(editor.onDidChangeModel(function () {
      return _this.update();
    }));
    this.callOnDispose.push(editor.onDidChangeModelLanguage(function () {
      return _this.update();
    }));
  ...
  FormatOnType.prototype.update = function () {
    ...
    this.callOnModel = dispose(this.callOnModel); // we are disabled
    ...
    var model = this.editor.getModel(); // no support
...
function () {
  ...
  FormatOnPaste.prototype.trigger = function (range) {
    ...
    getDocumentRangeFormattingEdits(model, range, {
      tabSize: tabSize,
...
function (_super) {
  ...
  AbstractFormatAction.prototype.run = function (accessor, editor) {
    ...
    var state = new EditorState(editor, 1
    /* Value */
    | 4
    /* Position */
    ); // Receive formatted value from worker

    return formattingPromise.then(function (edits) {
  ...
  if (editor) {
    ...
    function (_super) {
      ...
      class_1.prototype._getFormattingEdits = function (editor) {
        ...
        return editorSelection.isEmpty() ? getDocumentFormattingEdits(model, {
          tabSize: tabSize,
          insertSpaces: insertSpaces
