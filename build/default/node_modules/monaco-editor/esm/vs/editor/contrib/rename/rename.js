      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (!provider.resolveRenameLocation) return [3
            /*break*/
            , 2];
            return [4
            /*yield*/
            , asWinJsPromise(function (token) {
              return provider.resolveRenameLocation(_this.model, _this.position, token);
            })];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            /*yield*/
            , asWinJsPromise(function (token) {
              return provider.provideRenameEdits(_this.model, _this.position, newName, token);
            })];
          ...
          case 1:
            ...
            if (!result) {
              return [2
              /*return*/
              , this.provideRenameEdits(newName, i + 1, rejects.concat(nls.localize('no result', "No result.")))];
            } else if (result.rejectReason) {
              return [2
              /*return*/
              , this.provideRenameEdits(newName, i + 1, rejects.concat(result.rejectReason))];
            }
...
export function rename(model, position, newName) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      return [2
      /*return*/
      , new RenameSkeleton(model, position).provideRenameEdits(newName)];
    });
  });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , skeleton.resolveRenameLocation()];
          ...
          case 4:
            ...
            return [2
            /*return*/
            , this._renameInputField.getInput(loc.range, loc.text, selectionStart, selectionEnd).then(function (newNameOrFocusFlag) {
...
function (_super) {
  ...
  RenameAction.prototype.runCommand = function (accessor, args) {
    ...
    var _a = args || [undefined, undefined],
        uri = _a[0],
        pos = _a[1];
