...
function () {
  ...
  ColorDetector.prototype.onModelChanged = function () {
    ...
    var model = this._editor.getModel(); // if (!model) {
    // 	return;
    // }
  ...
  ColorDetector.prototype.beginCompute = function () {
    ...
    this._computePromise = createCancelablePromise(function (token) {
      return getColors(_this._editor.getModel(), token);
    });
  ...
  ColorDetector.prototype.getColorData = function (position) {
    ...
    var decorations = this._editor.getModel().getDecorationsInRange(Range.fromPositions(position, position)).filter(function (d) {
