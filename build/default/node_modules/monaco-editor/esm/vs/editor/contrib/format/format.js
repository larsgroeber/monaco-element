...
export function getDocumentRangeFormattingEdits(model, range, options) {
  ...
  return first(providers.map(function (provider) {
    return function () {
...
export function getDocumentFormattingEdits(model, options) {
  var providers = DocumentFormattingEditProviderRegistry.ordered(model); // try range formatters when no document formatter is registered
