  ...
  MarkdownRenderer.prototype.getOptions = function (disposeables) {
    ...
    return {
      codeBlockRenderer: function (languageAlias, value) {
        ...
        var modeId = languageAlias ? _this._modeService.getModeIdForLanguageName(languageAlias) : _this._editor.getModel().getLanguageIdentifier().language;
