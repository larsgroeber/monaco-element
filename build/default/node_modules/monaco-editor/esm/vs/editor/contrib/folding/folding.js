...
function () {
  function FoldingController(editor) {
    ...
    this.globalToDispose.push(FoldingRangeProviderRegistry.onDidChange(function () {
    ...
    this.globalToDispose.push({
      dispose: function () {
        return dispose(_this.localToDispose);
      }
    });
    this.onModelChanged();
  }
  ...
  FoldingController.prototype.onModelChanged = function () {
    ...
    this.localToDispose.push(this.editor.onDidChangeModelLanguageConfiguration(function (e) {
      return _this.onModelContentChanged();
    })); // covers model language changes as well

    this.localToDispose.push(this.editor.onDidChangeModelContent(function (e) {
      return _this.onModelContentChanged();
    }));
    ...
    if (this.updateScheduler) {
      ...
      this.foldingModelPromise = this.updateScheduler.trigger(function () {
        ...
        var foldingRegionPromise = _this.foldingRegionPromise = createCancelablePromise(function (token) {
          return _this.getRangeProvider(_this.foldingModel.textModel).compute(token);
        });
  ...
  FoldingController.prototype.onEditorMouseDown = function (e) {
    ...
    switch (e.target.type) {
      case MouseTargetType.GUTTER_LINE_DECORATIONS:
        ...
        var gutterOffsetX = data.offsetX - data.glyphMarginWidth - data.lineNumbersWidth - data.glyphMarginLeft; // TODO@joao TODO@alex TODO@martin this is such that we don't collide with dirty diff
