...
function () {
  ...
  Renderer.prototype.renderTemplate = function (container) {
    ...
    configureFont();
    chain(this.editor.onDidChangeConfiguration.bind(this.editor)).filter(function (e) {
  ...
  Renderer.prototype.renderElement = function (element, index, templateData) {
    ...
    data.highlightedLabel.set(suggestion.label, createMatches(element.matches), '', true); // data.highlightedLabel.set(`${suggestion.label} <${element.score}=score(${element.word}, ${suggestion.filterText || suggestion.label})>`, createMatches(element.matches));
  ...
  Renderer.prototype.disposeElement = function () {// noop
  };
...
function () {
  ...
  SuggestWidget = __decorate([__param(1, ITelemetryService), __param(2, IContextKeyService), __param(3, IThemeService), __param(4, IStorageService), __param(5, IKeybindingService), __param(6, IModeService), __param(7, IOpenerService)], SuggestWidget);
