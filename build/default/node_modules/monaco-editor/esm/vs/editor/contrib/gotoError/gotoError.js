...
function () {
  ...
  MarkerController.prototype._onMarkerChanged = function (changedResources) {
    ...
    if (!changedResources.some(function (r) {
      return _this._editor.getModel().uri.toString() === r.toString();
    })) {
      return;
    }
  ...
  MarkerController = __decorate([__param(1, IMarkerService), __param(2, IContextKeyService), __param(3, IThemeService), __param(4, ICodeEditorService)], MarkerController);
