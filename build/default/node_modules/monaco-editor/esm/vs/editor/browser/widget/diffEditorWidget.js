...
function (_super) {
  ...
  function DiffEditorWidget(domElement, options, editorWorkerService, contextKeyService, instantiationService, codeEditorService, themeService, notificationService) {
    ...
    if (options.automaticLayout) {
      _this._measureDomElementToken = window.setInterval(function () {
  ...
  DiffEditorWidget = __decorate([__param(2, IEditorWorkerService), __param(3, IContextKeyService), __param(4, IInstantiationService), __param(5, ICodeEditorService), __param(6, IThemeService), __param(7, INotificationService)], DiffEditorWidget);
...
function (_super) {
  ...
  DiffEdtorWidgetInline.prototype.setEnableSplitViewResizing = function (enableSplitViewResizing) {// Nothing to do..
  };
