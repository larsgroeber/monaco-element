...
function () {
  function OpenerService(_editorService, _commandService, _telemetryService) {
    if (_telemetryService === void 0) {
      _telemetryService = NullTelemetryService;
    }
  ...
  OpenerService.prototype.open = function (resource, options) {
    ...
    */
    ...
    if (scheme === Schemas.http || scheme === Schemas.https || scheme === Schemas.mailto) {
      ...
      promise = this._editorService.openCodeEditor({
        resource: resource,
        options: {
          selection: selection
        }
      }, this._editorService.getFocusedCodeEditor(), options && options.openToSide);
    }

    return promise;
  };

  OpenerService = __decorate([__param(0, ICodeEditorService), __param(1, ICommandService), __param(2, optional(ITelemetryService))], OpenerService);
