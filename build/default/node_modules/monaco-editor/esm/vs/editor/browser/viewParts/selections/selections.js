    ...
    for (var i = 0, len = visibleRanges.length; i < len; i++) {
      ...
      for (var j = 0, lenJ = lineVisibleRanges.ranges.length; j < lenJ; j++) {
        ...
        if (visibleRangesHaveStyle) {
          if (visibleRange.startStyle.top === 1
          /* INTERN */
          || visibleRange.startStyle.bottom === 1
          /* INTERN */
          ) {
              ...
              if (visibleRange.startStyle.bottom === 1
              /* INTERN */
              ) {
          ...
          if (visibleRange.endStyle.top === 1
          /* INTERN */
          || visibleRange.endStyle.bottom === 1
          /* INTERN */
          ) {
              ...
              if (visibleRange.endStyle.bottom === 1
              /* INTERN */
              ) {
        ...
        if (visibleRangesHaveStyle) {
          if (visibleRange.startStyle.top === 0
          /* EXTERN */
          ) {
              className += ' ' + SelectionsOverlay.SELECTION_TOP_LEFT;
            }

          if (visibleRange.startStyle.bottom === 0
          /* EXTERN */
          ) {
              className += ' ' + SelectionsOverlay.SELECTION_BOTTOM_LEFT;
            }

          if (visibleRange.endStyle.top === 0
          /* EXTERN */
          ) {
              className += ' ' + SelectionsOverlay.SELECTION_TOP_RIGHT;
            }

          if (visibleRange.endStyle.bottom === 0
          /* EXTERN */
          ) {
