...
function (_super) {
  ...
  function View(commandDelegate, configuration, themeService, model, cursor, execCoreEditorCommandFunc) {
    ...
    var viewController = new ViewController(configuration, model, execCoreEditorCommandFunc, _this.outgoingEvents, commandDelegate); // The event dispatcher will always go through _renderOnce before dispatching any events
  ...
  View.prototype.createViewParts = function () {
    ...
    PartFingerprints.write(this.overflowGuardContainer, 3
    /* OverflowGuard */
    );
    ...
    this.viewParts.push(this._scrollbar); // View Lines

    this.viewLines = new ViewLines(this._context, this.linesContent); // View Zones

    this.viewZones = new ViewZones(this._context);
    this.viewParts.push(this.viewZones); // Decorations overview ruler
    ...
    this.viewParts.push(margin); // Content widgets
    ...
    this.viewParts.push(this.viewCursors); // Overlay widgets
    ...
    this.viewParts.push(minimap); // -------------- Wire dom nodes up
