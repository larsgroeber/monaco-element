...
function (_super) {
  ...
  MouseDownOperation.prototype.start = function (targetType, e) {
    ...
    if (!this._context.configuration.editor.readOnly && this._context.configuration.editor.dragAndDrop && !this._mouseState.altKey // we don't support multiple mouse
    ...
    && this._currentSelection.containsPosition(position.position) // single click on a selection
        ...
        this._mouseMoveMonitor.startMonitoring(createMouseMoveEventMerger(null), function (e) {
