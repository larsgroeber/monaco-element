...
function () {
  ...
  InternalEditorOptions._equalFindOptions = function (a, b) {
    return a.seedSearchStringFromSelection === b.seedSearchStringFromSelection && a.autoFindInSelection === b.autoFindInSelection && a.globalFindClipboard === b.globalFindClipboard;
  };
  /**
   * @internal
   */
  ...
  InternalEditorOptions._equalsSuggestOptions = function (a, b) {
    if (a === b) {
      ...
      return a.filterGraceful === b.filterGraceful && a.snippets === b.snippets && a.snippetsPreventQuickSuggestions === b.snippetsPreventQuickSuggestions;
    }
  };
  /**
   * @internal
...
function () {
  ...
  InternalEditorOptionsFactory._tweakValidatedOptions = function (opts, accessibilitySupport) {
    var accessibilityIsOn = accessibilitySupport === 2
    /* Enabled */
    ;
