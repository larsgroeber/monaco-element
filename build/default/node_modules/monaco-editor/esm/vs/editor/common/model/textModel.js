...
function (_super) {
  ...
  function TextModel(source, creationOptions, languageIdentifier, associatedResource) {
    ...
    var bufferTextLength = _this._buffer.getValueLengthInRange(new Range(1, 1, bufferLineCount, _this._buffer.getLineLength(bufferLineCount) + 1), model.EndOfLinePreference.TextDefined); // !!! Make a decision in the ctor and permanently respect this decision !!!
  ...
  TextModel.prototype.dispose = function () {
    ...
    this._tokens = null;
    this._isDisposed = true; // Null out members, such that any use of a disposed model will throw exceptions sooner rather than later
  ...
  TextModel.prototype.setValueFromTextBuffer = function (textBuffer) {
    ...
    this._increaseVersionId(); // Cancel tokenization, clear all tokens and begin tokenizing
  ...
  TextModel.prototype._resetTokenizationState = function () {
    ...
    var tokenizationSupport = this._isTooLargeForTokenization ? null : TokenizationRegistry.get(this._languageIdentifier.language);
  ...
  TextModel.prototype.onBeforeAttached = function () {
    this._attachedEditorCount++; // Warm up tokens for the editor
  ...
  TextModel.prototype.getValueInRange = function (rawRange, eol) {
    if (eol === void 0) {
      eol = model.EndOfLinePreference.TextDefined;
    }
  ...
  TextModel.prototype._applyEdits = function (rawOperations) {
    ...
    if (contentChanges.length !== 0) {
      ...
      for (var i = 0, len = contentChanges.length; i < len; i++) {
        ...
        var _a = TextModel._eolCount(change.text),
            eolCount = _a[0],
  ...
  TextModel.prototype.setMode = function (languageIdentifier) {
    ...
    this._languageIdentifier = languageIdentifier; // Cancel tokenization, clear all tokens and begin tokenizing
