...
function (_super) {
  ...
  function EditorWorkerServiceImpl(modelService, configurationService) {
    ...
    _this._workerManager = _this._register(new WorkerManager(_this._modelService)); // todo@joh make sure this happens only once
    ...
    _this._register(modes.LinkProviderRegistry.register('*', {
      provideLinks: function (model, token) {
        ...
        return wireCancellationToken(token, _this._workerManager.withWorker().then(function (client) {
  ...
  EditorWorkerServiceImpl = __decorate([__param(0, IModelService), __param(1, ITextResourceConfigurationService)], EditorWorkerServiceImpl);
