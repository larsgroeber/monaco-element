...
function (_super) {
  ...
  function CommonEditorConfiguration(options) {
    ...
    _this.onDidChange = _this._onDidChange.event; // Do a "deep clone of sorts" on the incoming options
...
var editorConfiguration = {
  ...
  'properties': {
    ...
    'editor.wordWrap': {
      ...
      'enumDescriptions': [nls.localize('wordWrap.off', "Lines will never wrap."), nls.localize('wordWrap.on', "Lines will wrap at the viewport width."), nls.localize({
    ...
    'editor.multiCursorModifier': {
      'type': 'string',
      'enum': ['ctrlCmd', 'alt'],
      'enumDescriptions': [nls.localize('multiCursorModifier.ctrlCmd', "Maps to `Control` on Windows and Linux and to `Command` on macOS."), nls.localize('multiCursorModifier.alt', "Maps to `Alt` on Windows and Linux and to `Option` on macOS.")],
      'default': 'alt',
      'description': nls.localize({
    ...
    'editor.acceptSuggestionOnEnter': {
      ...
      'enumDescriptions': ['', nls.localize('acceptSuggestionOnEnterSmart', "Only accept a suggestion with `Enter` when it makes a textual change."), ''],
    ...
    'editor.suggestSelection': {
      ...
      'enumDescriptions': [nls.localize('suggestSelection.first', "Always select the first suggestion."), nls.localize('suggestSelection.recentlyUsed', "Select recent suggestions unless further typing selects one, e.g. `console.| -> console.log` because `log` has been completed recently."), nls.localize('suggestSelection.recentlyUsedByPrefix', "Select suggestions based on previous prefixes that have completed those suggestions, e.g. `co -> console` and `con -> const`.")],
    ...
    'editor.renderWhitespace': {
      ...
      'enumDescriptions': ['', nls.localize('renderWhiteSpace.boundary', "Render whitespace characters except for single spaces between words."), ''],
