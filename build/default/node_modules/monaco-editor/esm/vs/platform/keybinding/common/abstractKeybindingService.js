  ...
  AbstractKeybindingService.prototype._dispatch = function (e, target) {
    ...
    if (this._statusService && this._currentChord) {
      if (!resolveResult || !resolveResult.commandId) {
        this._statusService.setStatusMessage(nls.localize('missing.chord', "The key combination ({0}, {1}) is not a command.", this._currentChord.label, keypressLabel), 10 * 1000
        /* 10s */
        );
    ...
    if (resolveResult && resolveResult.commandId) {
      ...
      if (typeof resolveResult.commandArgs === 'undefined') {
        this._commandService.executeCommand(resolveResult.commandId).done(undefined, function (err) {
