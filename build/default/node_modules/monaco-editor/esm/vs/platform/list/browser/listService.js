...
function () {
  ...
  ListService.prototype.register = function (widget, extraContextKeys) {
    ...
    var result = combinedDisposable([widget.onDidFocus(function () {
  ...
  ListService = __decorate([__param(0, IContextKeyService)], ListService);
  return ListService;
}();
...
function (_super) {
  ...
  function WorkbenchTree(container, configuration, options, contextKeyService, listService, themeService, instantiationService, configurationService) {
    ...
    }, computeStyles(themeService.getTheme(), defaultListStyles), options);
  ...
  WorkbenchTree = __decorate([__param(3, IContextKeyService), __param(4, IListService), __param(5, IThemeService), __param(6, IInstantiationService), __param(7, IConfigurationService)], WorkbenchTree);
...
function (_super) {
  ...
  function WorkbenchTreeController(options, configurationService) {
    ...
    _this.disposables = []; // if the open mode is not set, we configure it based on settings
  ...
  WorkbenchTreeController = __decorate([__param(1, IConfigurationService)], WorkbenchTreeController);
